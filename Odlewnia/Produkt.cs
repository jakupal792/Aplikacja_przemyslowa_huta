...
namespace Odlewnia
{
    [Serializable()] //umożliwienie serializacji obiektów
    internal class Produkt
    {
        ...
        /*
        public void Przetwarzaj_dane(bool zahartowano, double masa_po_obrobce) //wykonywanie obliczeń w nowym wątku
        {
            masa_po_obrobce = 122.221;
            zahartowano = true;

            if (zahartowano)
            {
                this.wartosc = this.masa_metalu * masa_po_obrobce + 500;
            }
            else
            {
                this.wartosc = this.masa_metalu * masa_po_obrobce + 100;
            }
        }
        */
